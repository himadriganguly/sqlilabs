...
if ($mysqli->query($query)) {echo "[*]...................Old database ".$dbname." purged if exists";
	echo "<br><br>\n";
...
if ($mysqli->query($query)) {echo "[*]...................Creating New database ".$dbname." successfully";
	echo "<br><br>\n";
...
$query = "CREATE TABLE ".$dbname.".user_info 
		(
		id INT(3) NOT NULL AUTO_INCREMENT,
...
$query = "CREATE TABLE ".$dbname.".user_login_info 
		(
		id INT(3) NOT NULL AUTO_INCREMENT,
		user_id INT(3) NOT NULL,
...
$query = "INSERT INTO ".$dbname.".user_login_info (id, user_id, ip_address, last_login) VALUES ('1', '1', '192.168.1.2', '2015-12-01 20:37:22'), ('2', '2', '192.168.1.3', '2015-12-22 20:37:22'), ('3', '3', '192.168.1.4', '2015-12-08 20:37:22'), ('4', '4', '192.168.1.5', '2015-12-09 20:37:22'), ('5', '5', '192.168.1.6', '2015-12-14 20:37:22'), ('6', '6', '192.168.1.7', '2015-11-20 20:37:22'), ('7', '7', '192.168.1.8', '2015-10-10 20:37:22'), ('8', '8', '192.168.1.9', '2015-06-13 20:37:22'), ('9', '9', '192.168.1.10', '2015-02-12 20:37:22'), ('10', '10', '192.168.1.11', '2015-08-09 20:37:22'), ('11', '11', '192.168.1.12', '2015-12-01 20:37:22'), ('12', '12', '192.168.1.20', '2015-01-01 20:37:22'), ('13', '13', '192.168.1.45', '2015-12-01 20:37:22'), ('14', '14', '192.168.1.150', '2015-07-01 20:37:22')";
if ($mysqli->query($query)) {echo "[*]...................Inserted data correctly into table 'USERS'";
	echo "<br><br>\n";
} else {echo "[*]...................Error inserting data: " . $mysqli->error;
	echo "<br><br>\n";
