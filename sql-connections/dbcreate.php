...
if (!$con) {
	echo die('[*]...................Could not connect to DB, check the creds in db-creds.inc: ' . mysql_error());
}

//purging Old Database
$sql = "DROP DATABASE IF EXISTS sqlilabs";
if (mysql_query($sql)) {echo "[*]...................Old database 'SQLILABS' purged if exists";
	echo "<br><br>\n";
} else {echo "[*]...................Error purging database: " . mysql_error();
	echo "<br><br>\n";
}

//Creating new database security
$sql = "CREATE database `sqlilabs`";
if (mysql_query($sql)) {echo "[*]...................Creating New database 'SQLILABS' successfully";
	echo "<br><br>\n";
...
$sql = "CREATE TABLE sqlilabs.users 
		(
...
if (mysql_query($sql)) {echo "[*]...................Creating New Table 'USERS' successfully";
	echo "<br><br>\n";
...
$sql = "CREATE TABLE sqlilabs.user_info 
		(
		id INT(3) NOT NULL AUTO_INCREMENT,
...
if (mysql_query($sql)) {echo "[*]...................Creating New Table 'USER INFO' successfully";
	echo "<br><br>\n";
} else {echo "[*]...................Error creating Table: " . mysql_error();
	echo "<br><br>\n";
}
...
$sql = "CREATE TABLE sqlilabs.user_login_info 
		(
		id INT(3) NOT NULL AUTO_INCREMENT,
		user_id INT(3) NOT NULL,
...
if (mysql_query($sql)) {echo "[*]...................Creating New Table 'USER LOGIN INFO' successfully";
	echo "<br><br>\n";
} else {echo "[*]...................Error creating Table: " . mysql_error();
	echo "<br><br>\n";
}
...
$sql = "INSERT INTO sqlilabs.user_login_info (id, user_id, ip_address, last_login) VALUES ('1', '1', '192.168.1.2', '2015-12-01 20:37:22'), ('2', '2', '192.168.1.3', '2015-12-22 20:37:22'), ('3', '3', '192.168.1.4', '2015-12-08 20:37:22'), ('4', '4', '192.168.1.5', '2015-12-09 20:37:22'), ('5', '5', '192.168.1.6', '2015-12-14 20:37:22'), ('6', '6', '192.168.1.7', '2015-11-20 20:37:22'), ('7', '7', '192.168.1.8', '2015-10-10 20:37:22'), ('8', '8', '192.168.1.9', '2015-06-13 20:37:22'), ('9', '9', '192.168.1.10', '2015-02-12 20:37:22'), ('10', '10', '192.168.1.11', '2015-08-09 20:37:22'), ('11', '11', '192.168.1.12', '2015-12-01 20:37:22'), ('12', '12', '192.168.1.20', '2015-01-01 20:37:22'), ('13', '13', '192.168.1.45', '2015-12-01 20:37:22'), ('14', '14', '192.168.1.150', '2015-07-01 20:37:22')";
if (mysql_query($sql)) {echo "[*]...................Inserted data correctly into table 'USERS'";
	echo "<br><br>\n";
} else {echo "[*]...................Error inserting data: " . mysql_error();
	echo "<br><br>\n";
